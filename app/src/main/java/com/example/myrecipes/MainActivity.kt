...
class MainActivity : ComponentActivity() {
                            ...
                            text = {
                                Row(
                                    ...
                                    Icon(
                                        ...
                                        modifier = Modifier.padding(end = 8.dp),
                                        tint = MaterialTheme.colorScheme.onSurface // Dopasowanie koloru ikony do motywu
                                    )
                                    Text(
                                        text = if (!deleteFileMode) "Delete" else "Cancel",
                                        color = MaterialTheme.colorScheme.onSurface // Dopasowanie koloru tekstu do motywu
                                    )
                                }
                            },
                            onClick = {
    ...
    fun DetailsScreen(
        ...
        val recipeSections = remember { mutableStateListOf(*parseRecipe(recipeContent).toTypedArray()) }
        val context = LocalContext.current
                        ...
                        Column(
                            ...
                            Row {
                                if (isEditing) {
                                    IconButton(
                                        onClick = {
                                            val newIngredients = section.ingredients.toMutableList().apply {
                                                add("" to "")
                                            }
                                            recipeSections[sectionIndex] = section.copy(ingredients = newIngredients)
                                        },
                                ...
                                Row(
                                    ...
                                    OutlinedTextField(
                                        ...
                                        onValueChange = { newName ->
                                            ...
                                            section.ingredients[index] = ingredientName to ingredientAmount
                                        },
                                    ...
                                    IconButton(
                                        onClick = {
                                            val sectionIndex = recipeSections.indexOf(section)
                                            val updatedIngredients = section.ingredients.toMutableList().apply {
                                                removeAt(index)
                                            }
                                            val updatedSection = section.copy(ingredients = updatedIngredients)
                                            recipeSections[sectionIndex] = updatedSection
                                            if (updatedIngredients.isEmpty()) {
                                                recipeSections.removeAt(sectionIndex)
                                            }
                                        },
                                        modifier = Modifier.size(48.dp)
                                    ) {
